#!/usr/bin/env node
// The claudinite-fleet-sheepdog pack's fleet-USAGE sweep — the third cross-repo reach the pack adds,
...
// below as the task's `code_work`, Action-side inside the enforcer repo's
...
// every member is the claudinite-fleet-sheepdog's whole job.
//
...
// member set is enumerated at runtime from the enforcer's own claudinite-fleet-sheepdog config,
