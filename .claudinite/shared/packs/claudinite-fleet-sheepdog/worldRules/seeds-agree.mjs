...
//   - inside `packSeeds` on its `claudinite-fleet-sheepdog` entry — what the fleet-pack-seed sweep
...
const rule = {
  ...
  run(ctx) {
    ...
    try {
      ...
      return []; // malformed JSON, or no claudinite-fleet-sheepdog config — loadConfig owns both findings
    }
