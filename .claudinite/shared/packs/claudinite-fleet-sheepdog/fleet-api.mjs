// The claudinite-fleet-sheepdog sweeps' cross-repo GitHub REST client. Dependency-free (global
...
// name it, and re-exported from the engine so the name has one home.
...
export async function isCovered(gh, fullName) {
  ...
  return fileExists(gh, fullName, SETTINGS_FILE);
}
