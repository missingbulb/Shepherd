#!/usr/bin/env node
// The sheepdog pack's fleet ROSTER sweep — one walk of the fleet answering the
...
//   - an unreadable/absent sheepdog config aborts the sweep — absence is not consent
