...
// vendor set for the packs that consumer DECLARES, and nothing more: a sheepdog repo
// declaring `basics` + `sheepdog` mounts four packs. Calling `discoverPacks()` from
